...
[![Download](https://img.shields.io/badge/Download-v0.1.0-blue?style=for-the-badge)](https://github.com/wolfberry-ab/privmark/releases/latest)
[![Platform](https://img.shields.io/badge/Windows%20%7C%20Linux-grey?style=for-the-badge)]()
...
- **Three view modes** — Source, Split, and Preview with smooth animated transitions
...
<!-- Replace with actual dark mode screenshot -->
...
| | PrivMark |
|---|---|
| **Price** | **Free** (paid features coming at $9) |
...
| **Privacy** | Zero telemetry, zero phone-home, zero tracking |
...
> AI features will be included in the $9 early access license. Price goes up to $19 after AI ships.
...
- **No telemetry** — PrivMark never phones home
