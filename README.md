...
[![Download](https://img.shields.io/badge/Download-v1.6.1-blue?style=for-the-badge)](https://github.com/wolfberry-ab/privmark/releases/latest)
...
| Package | Description |
|---------|-------------|
| [**PrivMark-darwin-x64.dmg**](https://github.com/wolfberry-ab/privmark/releases/latest) | Intel Mac |
| [**PrivMark-darwin-arm64.dmg**](https://github.com/wolfberry-ab/privmark/releases/latest) | Apple Silicon (M1/M2/M3/M4) |

> macOS builds are signed with our Apple Developer ID and notarized by Apple.
